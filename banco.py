...
class Aluno(models.Model):
    ...
    sobrenome = models.CharField(max_length=194)
    email = models.CharField(max_length=254)
    estado = models.CharField(max_length=2)
    cidade = models.CharField(max_length=50)
    endereco = models.CharField(max_length=194)
...
class AssociarMenuUsuario(models.Model):
    ...
    tipo_usuario = models.CharField(max_length=194)
...
class Curso(models.Model):
    id = models.BigAutoField(primary_key=True)
    nome_curso = models.CharField(max_length=194)
    ativo = models.BooleanField()
    data_inicio = models.DateField()
    data_termino = models.DateField()
    professorid = models.ForeignKey('Professor', models.DO_NOTHING, db_column='professorID')  # Field name made lowercase.
...
class Menu(models.Model):
    ...
    caminho = models.CharField(max_length=194)
...
class Professor(models.Model):
    ...
    cidade = models.CharField(max_length=50)
    endereco = models.CharField(max_length=194)
    usuarioid = models.BigIntegerField(db_column='usuarioID', blank=True, null=True)  # Field name made lowercase.
...
class Usuario(models.Model):
    ...
    last_login = models.DateTimeField(blank=True, null=True)
    email = models.CharField(unique=True, max_length=194)
    is_active = models.BooleanField()
    is_staff = models.BooleanField()
    is_superuser = models.BooleanField()
